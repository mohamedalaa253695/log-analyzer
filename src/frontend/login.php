...
if (isset($_POST['submit'])) {
    $auth = new Auth();
    $errors =  $auth->login($_POST['userName'], $_POST['password']);
}
            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        ...
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">LoggingAnalysis</div>
                    </div>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div class="mt-12">
                        ...
                        <form method="POST" action="login.php">
                            <?php if (isset($errors)) { ?>
                                <li class="text-sm text-red-500"><?php echo $errors['message']; ?> </li>
                            <?php } ?>
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">UserName</div>
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" name="userName" placeholder="Mohamed Alaa">
                            </div>
                            <div class="mt-8">
                            ...
                            <div class="mt-10">
                                ...
                                shadow-lg" type="submit" value="submit">
                                    Log In
                                </button>
